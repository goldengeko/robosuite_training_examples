...
class Agent():
    ...
    def __init__(self, actor_learning_rate, critic_learning_rate, input_dims, tau, env, gamma=0.99, update_actor_interval=2, 
                 warmup=1000, n_actions=2, max_size=1000000, layer1_size=256, layer2_size=128, batch_size=100, noise=0.1):
        ...
        self.critic1 = CriticNetwork(input_dims=input_dims, fc1_dims=layer1_size, fc2_dims=layer2_size,
                                  n_actions=n_actions,name='critic_1',learning_rate=critic_learning_rate)
        
        self.critic2 = CriticNetwork(input_dims=input_dims, fc1_dims=layer1_size, fc2_dims=layer2_size,
        ...
        self.target_critic1 = CriticNetwork(input_dims=input_dims, fc1_dims=layer1_size, fc2_dims=layer2_size,
                                  n_actions=n_actions,name='target_critic_1',learning_rate=critic_learning_rate)
        
        self.target_critic2 = CriticNetwork(input_dims=input_dims, fc1_dims=layer1_size, fc2_dims=layer2_size,
    ...
    def load_models(self): 
        try: 
            ...
            print("Successfully loaded models. Starting from checkpoints")
        except:
